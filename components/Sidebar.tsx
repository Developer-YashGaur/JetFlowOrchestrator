...
function DesktopSidebar() {
    ...
    return (
        <div className="hidden relative md:block min-w-[280px] max-w-[350px] h-screen overflow-hidden w-full bg-primary/5 dark:bg-secondary/30 dark:text-foreground text-muted-foreground border-r-2 border-separate ">
